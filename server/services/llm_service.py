...
4. Если вопрос пользователя не относится к hr-метрикам, например пользователь поздоровался или 
попрощался или написал любой другой вопрос не связанный с hr-метриками то в "relevant" поставь
False.
5. "timeframe":
...
6. Никогда не делай вычислений и не пиши числа в "result".
7. Ответ ВСЕГДА только JSON, без комментариев и текста.
8. Если метрика не распознаётся — укажи "metric": null.
